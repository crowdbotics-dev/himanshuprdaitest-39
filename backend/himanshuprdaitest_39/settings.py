"""
Django settings for himanshuprdaitest_39 project.
...
ROOT_URLCONF = 'himanshuprdaitest_39.urls'
...
WSGI_APPLICATION = 'himanshuprdaitest_39.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshuprdaitest_39 API",
    "DESCRIPTION": "API documentation for himanshuprdaitest_39 App",
    "VERSION": "v1",
}
